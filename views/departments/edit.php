<?php
// Vista de edición de departamentos
session_start();
...
$department = $departmentModel->findById($id);
if (!$department) {
    header('Location: index.php');
    exit;
}
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Editar: <?php echo htmlspecialchars($department['name']); ?></li>
                    </ol>
                </nav>
                        ...
                        <form action="update.php?id=<?php echo $id; ?>" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="shift_type" name="shift_type">
                                            <option value="Day" <?php echo ($department['shift_type'] == 'Day') ? 'selected' : ''; ?>>Diurno</option>
                                            <option value="Night" <?php echo ($department['shift_type'] == 'Night') ? 'selected' : ''; ?>>Nocturno</option>
                                            <option value="Mixed" <?php echo ($department['shift_type'] == 'Mixed') ? 'selected' : ''; ?>>Mixto</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="description" name="description" 
                                               value="<?php echo htmlspecialchars($department['description'] ?? ''); ?>" placeholder="Breve detalle..." />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-warning">
                                    <i class="ri-save-line"></i> Actualizar Departamento
                                </button>
                            </div>
                        </form>
                    </div>
