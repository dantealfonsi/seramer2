                        ...
                        <div class="d-flex justify-content-between align-items-center mb-5">
                            <h5 class="mb-0 d-flex align-items-center" style="font-size: 1.75rem; font-weight: 600; color: #43495b;">
                                <div class="p-2 rounded-3 me-3 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background-color: #e8fadf !important;">
                                    <i class="ri-bank-card-line" style="color: #71dd37; font-size: 1.5rem;"></i>
                                </div>
                            ...
                            <div class="card-body p-4 position-relative">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-circle me-3 d-flex align-items-center justify-content-center" style="width: 54px; height: 54px;">
                                        <i class="ri-money-dollar-box-line ri-2x text-white"></i>
                                    </div>
                                    <div>
                                        <h3 class="mb-0 text-white fw-bold"><?php echo number_format($totalMethods); ?></h3>
                                        <p class="mb-0 text-white-50 fw-semibold">Métodos de Pago Habilitados</p>
                                    </div>
                                </div>
                                <div class="position-absolute" style="right: -10px; bottom: -20px; opacity: 0.1;">
                                    <i class="ri-bank-card-line text-white" style="font-size: 6rem;"></i>
                                </div>
                            </div>
                        </div>
