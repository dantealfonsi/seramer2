                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title" style="font-size: 2rem;font-weight: 600;">
                            <i class="ri-edit-box-line me-1" style="font-size: 2rem;background: #837aff;color: white;font-weight: 100 !important;padding: .24rem;border-radius: .7rem;"></i>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                                ...
                                <select class="form-control" id="citation_id" name="citation_id" required>
                                    ...
                                    <?php foreach ($citations as $citation): ?>
                                        <option value="<?php echo htmlspecialchars($citation['citation_id']); ?>" <?php echo ($report['citation_id'] == $citation['citation_id']) ? 'selected' : ''; ?>>
                                            Citación #<?php echo htmlspecialchars($citation['citation_id']); ?> - <?php echo htmlspecialchars($citation['location']); ?> (<?php echo htmlspecialchars($citation['citation_datetime']); ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div id="reprogramming_fields" class="mb-3" style="display: none;">
                                <label for="reprogramming_datetime" class="form-label">Fecha y Hora de Reprogramación</label>
                                <input type="datetime-local" class="form-control" id="reprogramming_datetime" name="reprogramming_datetime" value="">
                            </div>
                            
                            <div class="mb-3">
                                <label for="agreement_details" class="form-label">Detalles del Acuerdo (Opcional)</label>
                                <textarea class="form-control" id="agreement_details" name="agreement_details" rows="5"><?php echo htmlspecialchars($report['agreement_details'] ?? ''); ?></textarea>
                            </div>
