...
$report_names = [
    ...
    'infractions_by_month' => 'Infracciones por Mes',
    'employees_by_department' => 'Empleados por Departamento',
    'inspection_productivity' => 'Productividad de la Inspección',
    'inspector_performance' => 'Desempeño de Inspectores',
    'revenue_by_type' => 'Ingresos por Tipo de Infracción'
];

$selected_report = $_GET['report_type'] ?? null;
$selected_mode_param = $_GET['report_mode'] ?? null; 

$current_report_name = $report_names[$selected_report] ?? 'Reporte General';
$page_title = "Reporte: " . $current_report_name;
            ...
            <div class="col-12">
                <div class="d-flex align-items-center">
                    <div class="p-2 rounded-3 me-3 d-flex align-items-center justify-content-center" style="width: 56px; height: 56px; background-color: #e7e7ff !important;">
                        <i class="ri-bar-chart-line" style="color: #696cff; font-size: 2rem;"></i>
                    </div>
                    <div>
                        <h2 class="mb-0 fw-bold" style="color: #43495b;"><?php echo htmlspecialchars($page_title); ?></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="#">Fiscalización</a></li>
                                <li class="breadcrumb-item"><a href="index.php">Reportes de Fiscalización</a></li>
                                <?php if ($selected_report): ?>
                                <li class="breadcrumb-item active"><?php echo htmlspecialchars($current_report_name); ?></li>
                                <?php endif; ?>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <form id="reportForm" action="" method="GET" class="card p-3 mb-4 shadow-sm">
                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-6" style="display: none;">
                                    <label for="report_type" class="form-label small">Tipo de Reporte Oculto</label>
                                ...
                                <div class="col-md-6">
                                    <label for="report_mode" class="form-label small">1. Seleccione el Modo o Alcance</label>
