...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-01-2026 a las 03:24:50
...
(1, 2, '2025-08-04', '2026-01-19 02:41:32', 1167.04, 'Biopago', 'Paid', '454454', 2, 5),
(2, 2, '2025-08-04', '2026-01-19 02:41:43', 1167.04, 'Biopago', 'Paid', '5455', 2, 5),
(3, 2, '2025-08-04', '2026-01-19 03:01:34', 1167.04, 'Biopago', 'Paid', '7777', 2, 5);
...
(9, 2, 1, '2025-12-07 21:14:16', 3, 'asdasdasdasda', 'Reported', '', '', 'active'),
(10, 2, 1, '2026-01-19 16:26:43', 7, 'TESTasdasdsd', 'Cancelled', '', '', 'active'),
(11, 2, 1, '2026-01-19 16:38:03', 28, 'asdasaaassdfsdf', 'Reported', 'asdasdasdsad', '', 'active');
...
INSERT INTO `market_stalls` (`id`, `awardee_id`, `sector_id`, `stall_number`, `location_description`) VALUES
(1, 2, 1, 'L-001', 'testing');
...
INSERT INTO `notifications` (`notification_id`, `notification_datetime`, `sender_user_id`, `recipient_user_id`, `target_role_id`, `target_department_id`, `is_global`, `notification_type`, `notification_subject`, `notification_message`, `read_status`, `complaint_id`, `alert_id`, `infraction_id`) VALUES
(5, '2025-12-07 20:14:16', 8, 8, NULL, NULL, 0, 'infraction_new', 'Nueva Infracción Registrada', 'Se ha registrado una nueva infracción con ID #9. Por favor, revise los detalles.', 1, 9, NULL, NULL),
(6, '2026-01-19 15:26:44', 8, 8, NULL, NULL, 0, 'infraction_new', 'Nueva Infracción Registrada', 'Se ha registrado una nueva infracción con ID #10. Por favor, revise los detalles.', 1, 10, NULL, NULL);
...
(9, 9, 1, 20000.00, 'VES', '2025-12-07 20:14:16', '0000-00-00', '0000-00-00', 'Imposed', '', 0, 1),
(10, 10, 1, 400.00, 'VES', '2026-01-19 15:26:44', '2026-01-05', '0000-00-00', 'Cancelled', '', 0, 1),
(11, 11, 2, 400.00, 'VES', '2026-01-19 15:38:03', '0000-00-00', '0000-00-00', 'Imposed', 'asdasdasdsad', 0, 1);
...
(9, '2026-01-21', 'Complain', 8, 'In Progress', 'asdasd', '2026-01-19 05:00:43');
...
(1, 1, 'mmaria', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'maria.gonzalez@empresa.com', '2025-12-07 03:13:14', NULL, NULL, 'active', '2025-08-02 21:28:47', '2025-12-07 07:13:14'),
...
(4, 4, 'lmartinez', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'luis.martinez@empresa.com', '2026-01-19 23:34:26', NULL, NULL, 'active', '2025-08-02 21:28:47', '2026-01-20 03:34:26'),
(5, NULL, 'devliq', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'devliquidacion@empresa.com', '2026-01-19 23:35:48', NULL, NULL, 'active', '2025-08-02 21:28:47', '2026-01-20 03:35:48'),
(6, NULL, 'devcob', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'devcobranza@empresa.com', '2026-01-18 22:35:53', NULL, NULL, 'active', '2025-08-02 21:28:47', '2026-01-19 02:35:53'),
(7, 9, 'devrrhh', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'devrrhh@empresa.com', '2026-01-19 23:31:50', NULL, NULL, 'active', '2025-08-02 21:28:47', '2026-01-20 03:31:50'),
(8, 7, 'devfisc', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'devfiscalizacion@empresa.com', '2026-01-20 22:16:59', NULL, NULL, 'active', '2025-08-02 21:28:47', '2026-01-21 02:16:59'),
(9, 9, 'afigueroa', '$2y$10$c1/w.fOiN.1tFuNTUJ0ZnuejWAUnTP.EFcds7MHQnu1G/h47gw7Ly', 'Andres.Figueroa@empresa.com', '2026-01-19 23:33:19', NULL, NULL, 'active', '2025-08-03 02:56:10', '2026-01-20 03:33:19'),
...
(11, 10, 'arojas', '$2y$12$DxcEraAN3tao8.z.FaOgsuz5jP39VqoFpDSQU3qZDgioePvAK6vh6', 'ana.rojas@empresa.com', '2026-01-17 13:57:01', NULL, NULL, 'active', '2025-08-04 16:42:11', '2026-01-17 17:57:01'),
...
--
ALTER TABLE `fiscalization_roles`
  MODIFY `role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=677;

--
-- AUTO_INCREMENT de la tabla `fiscalization_user_level`
--
ALTER TABLE `fiscalization_user_level`
  MODIFY `user_level_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;
...
--
ALTER TABLE `infractions`
  MODIFY `infraction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `sanctions`
  MODIFY `sanction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
