...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2025 a las 16:49:36
...
ALTER TABLE `sanction_types`
  ...
  ADD UNIQUE KEY `sanction_type_name` (`sanction_type_name`);
...
--
ALTER TABLE `infractions`
  MODIFY `infraction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `infraction_types`
--
ALTER TABLE `infraction_types`
  MODIFY `infraction_type_id` int(11) NOT NULL AUTO_INCREMENT;
