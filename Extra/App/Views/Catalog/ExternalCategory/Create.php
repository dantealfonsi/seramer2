    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Crear Rubro Externo</h5>
            </div>
            <div class="card-body">
                <form action="<?= $app['url'] ?>/externalcategory/store" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="installation_type" name="installation_type" placeholder="Ej: CAMIÓN / CAVAS" />
